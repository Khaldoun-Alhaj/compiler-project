// Generated from C:/Users/digital world/Documents/intelijProjects/compiler-project/java-compiler/grammar/WebLexer.g4 by ANTLR 4.13.2
 package antlr; 
...
public class WebLexer extends Lexer {
	...
	public static final int
		STYLE_TAG_MODE=1, TAG_MODE=2, JINJA_MODE=3, CSS_MODE=4;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "STYLE_TAG_MODE", "TAG_MODE", "JINJA_MODE", "CSS_MODE"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"HTML_COMMENT", "JINJA_COMMENT", "WS", "JINJA_STMT_OPEN", "JINJA_EXPR_OPEN", 
